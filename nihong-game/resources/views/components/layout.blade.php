...
<div class="relative bg-zinc-900">
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
    ...
    <div class="hidden space-x-10 md:flex text-orange-600 ">
        ...
        <a class="whitespace-nowrap text-base font-medium " href="/vocabs">Vocabs</a>
...
{{-- Start of footer --}}
<footer class="text-center text-white bg-zinc-900">
    <div class="container pt-9">
      <div class="flex justify-center mb-9">
        <a href="#!" class="mr-9 text-orange-600">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
    ...
    <div class="text-center text-orange-600 p-4" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2022 Copyright:
      <a class="text-orange-600" href="https://tailwind-elements.com/">Ervin Bautista</a>
    </div>
  </footer>
